...
this link by running `/calendar` in Discord.
...
| `/calendar` | anyone | Ephemeral subscribe link + Google/Apple setup steps. Needs `PUBLIC_URL` or `RENDER_EXTERNAL_URL`; without either, replies that the feed isn't configured |
